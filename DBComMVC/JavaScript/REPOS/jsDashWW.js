...
var aFaturarGeralMarca = 0,
    aFaturarEquipe = 0,
    aFaturarEquipePerc = 0;
var ttMetaGeralEquipes = 0,
    perc_ttMetaGeralEquipes = 0;
var valFatuMesEquipes = "",
    percFatuMesEquipes = 0;
var valConsolidadoDia = "",
    valConsolidadoMes = "",
...
function AtualizaCamposGerais() {
    $.getJSON("api/DB_Vendas_a_Faturar/'W'").done(function (data) {
    ...
    $.getJSON("api/DB_Vendas_Consolidado_Dia/'W'").done(function (data) {
        ArrConsolidadoDia = [];
        valConsolidadoDia = 0;
...
function AtualizaResultadoCanaisEquipes() {
    $.getJSON("api/DB_Resultado_Equipes/WW").done(function (data) {
...
function agora() {
    ...
    while (i <= atualizacaoDash) {
        i++;
        var d = new Date();
        if (d.getTimezoneOffset() == 120) { } else if (d.getTimezoneOffset() == 180) { } else {
